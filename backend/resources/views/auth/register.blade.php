...
<head>
    ...
    <style>
        ...
        .glow { position: absolute; width: 500px; height: 500px; background: radial-gradient(circle, rgba(168, 85, 247, 0.1) 0%, transparent 70%); border-radius: 50%; filter: blur(80px); z-index: -1; }
...
<body class="overflow-hidden h-screen flex">
    ...
    <div class="flex flex-1 min-h-full">
        ...
        <!-- Left: Visual Content -->
        <div class="hidden lg:flex flex-1 relative items-center justify-center overflow-hidden bg-background border-r border-border">
            <div class="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-5"></div>
            <div class="relative z-10 w-full max-w-lg space-y-12 text-center">
                <div class="space-y-4">
                    <h2 class="text-4xl font-bold font-heading">Forge links that <span class="text-accent italic">convert.</span></h2>
                    <p class="text-zinc-500 px-12">Join 50,000+ creators and businesses scaling their brand with advanced link management.</p>
                </div>
                
                <div class="relative h-64">
                    <div class="glass p-6 rounded-3xl absolute top-0 left-1/4 w-64 shadow-2xl -rotate-6">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-8 h-8 rounded-lg bg-emerald-500/20 text-emerald-500 flex items-center justify-center"><i data-lucide="bar-chart" class="w-4 h-4"></i></div>
                            <span class="text-xs font-bold">Live Conversion</span>
                        </div>
                        <div class="text-2xl font-bold">24.8%</div>
                    </div>
                    <div class="glass p-6 rounded-3xl absolute bottom-0 right-1/4 w-64 shadow-2xl rotate-3 bg-accent/5 border-accent/20">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-8 h-8 rounded-lg bg-accent/20 text-accent flex items-center justify-center"><i data-lucide="link" class="w-4 h-4"></i></div>
                            <span class="text-xs font-bold">New Custom Alias</span>
                        </div>
                        <div class="text-xs text-zinc-400 truncate">forge.li/summer-sale</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        Back to homepage
                ...
                <form id="registerForm" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2 ml-1">Full Name</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2 ml-1">Email</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2 ml-1">Password</label>
                        <input type="password" id="password" required placeholder="Min. 8 characters" oninput="checkStrength()"
                            class="w-full bg-white/5 border border-border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent transition-all placeholder:text-zinc-600">
                    ...
                    <button type="submit" id="regBtn" class="w-full py-4 bg-accent hover:bg-accent/90 text-white font-bold rounded-2xl shadow-lg shadow-accent/20 transition-all">
                        Create Account
                    </button>
                </form>
