...
<head>
    ...
    <style>
        body { background-color: #09090b; color: #fafafa; -webkit-font-smoothing: antialiased; }
        .glass { background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.08); }
        .glow { position: absolute; width: 400px; height: 400px; background: radial-gradient(circle, rgba(99, 102, 241, 0.15) 0%, transparent 70%); border-radius: 50%; filter: blur(60px); z-index: -1; }
        .auth-animate { animation: fadeIn 0.6s ease-out forwards; }
        ...
        <div class="flex-1 flex flex-col justify-center px-8 md:px-12 lg:px-24 xl:px-32 z-10">
            <div class="max-w-md w-full mx-auto auth-animate">
                ...
                <div class="flex items-center gap-2 mb-10">
                    <div class="w-10 h-10 bg-accent rounded-xl flex items-center justify-center shadow-lg shadow-accent/25">
                        <i data-lucide="link-2" class="text-white w-6 h-6"></i>
                    </div>
                    <span class="text-2xl font-bold font-heading tracking-tight">LinkForge</span>
                </div>
                ...
                <form id="loginForm" class="space-y-5">
                    <div>
                        <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2 ml-1">Email Address</label>
                    ...
                    <div class="relative">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            {{-- <a href="#" class="text-[10px] font-bold text-accent hover:text-accent/80 uppercase">Forgot?</a> --}}
                        </div>
                        <input type="password" id="password" required placeholder="••••••••" 
                            class="w-full bg-white/5 border border-border rounded-2xl px-5 py-4 text-sm focus:outline-none focus:border-accent transition-all placeholder:text-zinc-600">
                        <button type="button" onclick="togglePassword()" class="absolute right-5 top-[52px] text-zinc-500 hover:text-zinc-300">
                    ...
                    <button type="submit" id="submitBtn" class="w-full py-4 bg-accent hover:bg-accent/90 text-white font-bold rounded-2xl shadow-lg shadow-accent/20 transition-all flex items-center justify-center gap-2 group">
                        <span>Sign In</span>
...
{{-- 
                ...
                <p class="text-center mt-10 text-xs text-zinc-500">
                    Don't have an account? <a href="{{ route('register') }}" class="text-accent font-bold hover:underline">Create account</a>
                </p>
            </div>
        </div>
        ...
        <div class="hidden lg:flex flex-1 relative items-center justify-center overflow-hidden bg-surface">
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,_#312e81,_transparent_60%)] opacity-30"></div>
            
            <div class="relative z-10 w-full max-w-lg p-8">
                <!-- Mockup Elements -->
                <div class="space-y-6">
                    <div class="glass p-6 rounded-[2rem] shadow-2xl rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                        <div class="flex items-center justify-between mb-6">
                            <h3 class="text-sm font-bold">Clicks Distribution</h3>
                            <div class="flex gap-1"><div class="w-2 h-2 rounded-full bg-rose-500"></div><div class="w-2 h-2 rounded-full bg-amber-500"></div><div class="w-2 h-2 rounded-full bg-emerald-500"></div></div>
                        </div>
                    ...
                    <div class="flex gap-6">
                        <div class="glass flex-1 p-6 rounded-[2rem] shadow-2xl translate-x-12 hover:translate-x-0 transition-transform duration-500">
                        ...
                        <div class="glass flex-1 p-6 rounded-[2rem] shadow-2xl bg-accent/10 border-accent/20">
                            ...
                            <div class="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Global Reach</div>
                        </div>
                    </div>
                </div>
            </div>
