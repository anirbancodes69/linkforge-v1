        ...
        <div class="lg:col-span-8 space-y-8">
            ...
            <div class="glass rounded-2xl overflow-hidden">
                ...
                <div class="p-6 border-b border-border flex items-center justify-between">
                    ...
                    <a href="{{ route('links.index') }}" class="text-xs font-medium text-accent hover:underline">
                        View All
                    </a>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <thead class="bg-white/5">
                            <tr>
                                ...
                                <th
                                    class="px-6 py-4 text-xs font-semibold text-zinc-400 uppercase tracking-wider text-center">
                                    Clicks
                                </th>
                        ...
                        <tbody id="recentLinksTable" class="divide-y divide-border">
                        </tbody>
        ...
        <div class="lg:col-span-4 space-y-8">
            ...
            <div class="glass p-6 rounded-3xl">
                ...
                <div class="flex gap-2 overflow-x-auto pb-2 mb-6 scrollbar-hide">
                    ...
                    <button class="analytics-tab" data-tab="cities">
                        Cities
                    </button>
                ...
                <!-- Dynamic Content -->
                <div id="analyticsContent" class="min-h-[300px]">
                </div>
