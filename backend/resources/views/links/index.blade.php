...
@section('content')
    ...
    <div class="glass rounded-2xl overflow-hidden">
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody id="linksTableBody" class="divide-y divide-border"></tbody>
    ...
    <!-- Empty State -->
    <div id="emptyState" class="hidden glass rounded-2xl p-16 text-center mt-6">

        <div class="w-20 h-20 rounded-3xl bg-white/5 flex items-center justify-center mx-auto mb-6">

            <i data-lucide="link-2" class="w-10 h-10 text-zinc-500"></i>
...
<div
    ...
    class="hidden flex flex-col md:flex-row items-center justify-between gap-4 mt-6 px-2"
>

    <div class="text-sm text-zinc-500">
        Showing
        <span id="paginationFrom">0</span>
        -
        <span id="paginationTo">0</span>
        of
    ...
    <div class="flex items-center gap-2">
        ...
        <button
            id="prevPageBtn"
            class="px-4 py-2 text-xs font-bold glass rounded-xl text-zinc-400 hover:text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
            Previous
        </button>
