            ...
            <div class="flex flex-col h-full">
                ...
                <div class="h-16 flex items-center px-6 border-b border-border">
                    <div class="flex items-center gap-2 group cursor-pointer">
                        ...
                        <span class="text-xl font-bold font-heading tracking-tight">WEBN ADMIN</span>
                    </div>
                </div>
                ...
                <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-accent text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5' }} group transition-all">
